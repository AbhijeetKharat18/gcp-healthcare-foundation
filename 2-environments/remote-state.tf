# 2-environments / remote-state.tf
...
locals {
  ...
  seed_project    = data.terraform_remote_state.bootstrap.outputs.seed_project_id

  # env name -> folder id (folders/NNN). Strip prefix for google_project.
  env_folder_ids = {
